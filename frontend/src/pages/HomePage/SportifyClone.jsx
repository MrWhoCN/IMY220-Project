    ...
    return (
        <div className="container">
            ...
            <main className="mainContent">
                {/* Use one PlaylistSection with a merged title and playlists */}
                <PlaylistSection title="Suggestion & Top Hits" subtitle="Focus & Top Charts" playlists={combinedPlaylists} />
            </main>
        </div>
    );
}
